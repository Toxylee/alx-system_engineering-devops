#!/usr/bin/python3
"""
Python script using REST API for a given employee ID, returns
information about his/her TODO list progress.
Extends the Python script to export data in the JSON format.
"""
import json
import requests
...
if __name__ == "__main__":
    ...
    """The username will be the same for an id, get the 1st username"""
